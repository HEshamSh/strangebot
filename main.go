...
func main() {
	...
	mysqlUser := os.Getenv("xovzzafbniuiyn")
	mysqlPassword := os.Getenv("191e096e426598726832e204bf353755bb69fc96b8a5b088d583d7f4900f4663")
	mysqlDatabaseName := os.Getenv("postgresql-animated-75042")
	telegramBotKey := os.Getenv("992185043:AAEVwuBj-rzMmOuCf9mtpfQDlDNaOeRC_YA")
